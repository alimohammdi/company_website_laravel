        ...
        <section class="row m-0 mt-4">
            <section class="col-8 offset-2 bg-dark text-white p-2">
                @if(session('create-post'))
                    <div class="alert alert-success m-2"> {{session('create-post') }} </div>
                @endif
...
['class'=>'form-control mt-2']) !!}
                ...
                <section class="d-block">
                    ...
                    {!! Form::select('category',$category,null,['class'=>'form-control mt-2']); !!}
                </section>
                <section class="d-block">
                    {!! Form::submit('create',['class'=>'btn btn-success m-2 ']); !!}
                </section>
                {{ Form::close() }}
                <a href="{{ route('post.index') }}" class="btn btn-info m-2"> show post</a>
            </section>
        </section>
    </section>
@endsection
